...
class DistributedDataParallelModel(torch.nn.parallel.DistributedDataParallel):
...
def _criterion_parallel_apply(modules, inputs, targets, kwargs_tup=None, devices=None):
    ...
    def _worker(i, module, input, target, kwargs, device=None):
        ...
        try:
            ...
            with lock:
                results[i] = e  # results[i] = ExceptionWrapper(where="in replica {} on device {}".format(i, device))
